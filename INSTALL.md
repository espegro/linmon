...
```ini
CapabilityBoundingSet=CAP_DAC_OVERRIDE CAP_FOWNER CAP_BPF CAP_PERFMON CAP_NET_ADMIN CAP_SYS_ADMIN CAP_SYS_RESOURCE CAP_SETUID CAP_SETGID CAP_SETPCAP CAP_SYS_PTRACE
```
